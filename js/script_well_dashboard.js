...
$('#plunger-spark').sparkline([8,75,3,5,1,6,19,92,76],options);
$('#line-spark').sparkline([1,44,76,6,8,25,3,45,2,6,19,2,6],options);
$('#casing-spark').sparkline([1,44,96,25,3,45,21,6,19,2,6],options);
$('#flow-spark').sparkline([1,44,3,45,21,6,19,2,6],options);
      $('.tab-container').tabs({
		  show:function(id){
			if(id=="tabs1")
			{
