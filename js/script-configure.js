...
$(document).ready(function(){
	$(".leftOverviewEditRowWebServer").hover(function(){
		$(this).find("img.pen").show();
		},function(){
		$(this).find("img.pen").hide();
		});
		
		$(".leftOverviewEditRowWebServer .edit-pen").click(function() {
	...
	$("#comboLocUserAuth").combomenu({isCombo:true,onOverlay:true,width: 90});
	$("#comboLocSecure").combomenu({isCombo:true,onOverlay:true,width: 90});
